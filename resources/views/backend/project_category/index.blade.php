            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('create.project_category') }}" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    @forelse($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit.project_category', $category->id) }}"
                                                    class="btn btn-sm btn-warning">
                                                    <i class="mdi mdi-pencil"></i>
                                                </a>
                                                <form action="{{ route('destroy.project_category', $category->id) }}"
