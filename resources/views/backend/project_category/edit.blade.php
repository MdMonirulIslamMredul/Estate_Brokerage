        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Project Category</h4>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update.project_category', $category->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                @if ($category->image)
                                    <div class="mb-2">
                                        <img src="{{ asset($category->image) }}" width="150" height="150"
                                            alt="{{ $category->name }}">
                                    </div>
                                @endif
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('status') is-invalid @enderror" type="radio"
                                        ...
                                        {{ (string) old('status', $category->status ?? '1') === '1' ? 'checked' : '' }}
                                        required>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('status') is-invalid @enderror" type="radio"
                                        ...
                                        {{ (string) old('status', $category->status ?? '1') === '0' ? 'checked' : '' }}>
