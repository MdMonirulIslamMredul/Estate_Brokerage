        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Create Project Subcategory</h4>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('store.project_subcategory') }}" method="POST" enctype="multipart/form-data"
                            id="subcategoryForm">
                            @csrf
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary" id="submitBtn">
                                    <i class="mdi mdi-content-save"></i> Create Subcategory
                                </button>
